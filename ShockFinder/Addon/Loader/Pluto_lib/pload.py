...
try:
    import ShockFinder.Addon.Loader.Pluto_lib.Tools as Tools
except:
    import Pluto_lib.Tools as Tools
            ...
            try:
                ...
                if line.split()[0] == b"SCALARS":
                    ...
                    if self.Slice:
                        ...
                        indxx = np.sort(
                            [
                                self.n3_tot * self.n2_tot * k + j * self.n2_tot + i
    ...
    def ReadDataFile(self, num):
        ...
        **Outputs**:
        ...
        if self.filetype == "single_file":
            ...
            self.ReadSingleFile(
                datafilename, self.vars, self.n1, self.n2, self.n3, endian, dtype, ddict
            )
